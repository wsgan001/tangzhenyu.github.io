...
**Paper Link:[U-Net: Convolutional Networks for Biomedical Image Segmentation](http://arxiv.org/abs/1505.04597)**
**Homepage:<http://lmb.informatik.uni-freiburg.de/people/ronneber/u-net/>**

The network architecture is as follows:

![](/assets/paper_notes/unet/unet1.jpg)

**Implementation U-net in Pytorch**
